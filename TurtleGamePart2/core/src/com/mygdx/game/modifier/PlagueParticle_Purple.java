...
public class PlagueParticle_Purple extends PlagueParticle implements Pool.Poolable
{
    /////////////////////////////////////////////////////////////////////////////////
    // VARIABLE

    public static Sound purpleCoronaSound = Gdx.audio.newSound(Gdx.files.internal("purpleCoronaSound.wav"));
    ...
    //public PlagueParticle_Purple(float x, float y, Stage s) spawnchunks replace with next line
    public PlagueParticle_Purple(float x, float y, Stage s, int arrIndexX, int arrIndexY)
    {
        super( x, y, s );
        loadTexture("purple_corona.png");
    ...
    public void rotate(Player player)
    {
        ...
        {
            System.out.println("PPP: Touched a PPP"); //spawnchunk addition

            player.rotateBy(90);
            DebugLevel.dummySickFace.rotateBy(90);
            DebugLevel.dummySickFace.setVisible(true);
            DebugLevel.dummySickFaceFilter.rotateBy(90);
