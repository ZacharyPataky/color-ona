...
public abstract class BaseGame extends Game
{
    ...
    public void create()
    {
        ...
        FreeTypeFontGenerator fontGenerator =
                new FreeTypeFontGenerator(Gdx.files.internal("Rubik-Regular.ttf"));
                //new FreeTypeFontGenerator(Gdx.files.internal("OpenSans.ttf"));
        FreeTypeFontParameter fontParameters = new FreeTypeFontParameter();
        fontParameters.size = 48;
        fontParameters.color = Color.WHITE;
        //fontParameters.borderWidth = 2;
        fontParameters.borderWidth = 2.5f;
        //fontParameters.borderGamma = 0.3f;
        ...
        smallLabelStyle.font = customFont;
    }
